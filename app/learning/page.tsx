    ...
    return (
        <>
            ...
            <section>
                ...
                <p>"Person who is good at archery learns from the bow but not from Master Yi (羿); person who is good at boating learns from the boat but not from Master Ao (奡); person who is good at the mind learns from the mind but not from the sages.", Taoist philosopher Guanyinzi (關尹子) said.</p>
                ...
                <p>"When Master Zilu (子路) was told of his faults, he was glad; when Chief Yu (禹), heard good words, he bowed; Chief Shun the Great (大舜) was even greater: he shared goodness with others. He would set aside his own opinion to follow others, taking joy in learning goodness from them. From farming, pottery, fishing, to ruling, all kinds of skills involved learning from others. To take goodness from others and practice it is to help others do good.", Confucian philosopher Mencius said. </p>
                <p>"The principles refer to the supreme method for doing everything in the world. There are countless ways of principles in this world: Buddhism focuses on the acts of salvation; Confucianism focuses on learning the rules of conduct and interpersonal relations; healers have the principles of healing, actors have the principles of acting, tea ceremony has the principles of tea ceremony, and archers have the principles of archery. There are many forms of the principles; living in this world is simply a matter of choosing the principles that suits oneself, learning it, and adapting to it. Guidance cannot replace practice. All you have to do is work hard. Diligence is the shortcut to getting started; only through diligent practice and careful reflection can you truly understand the principles. Mastering the second technique of blade is merely the beginning; continuous practice is required moving forward. Only in this way can one ultimately enter the highest realm of military strategy through careful reflection and understanding.", Japanese swordman Miyamoto Musashi (宮本武藏) exhorted.</p>
